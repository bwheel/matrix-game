...
from ..components import Display, Fonts, FontSize, FontSizes, Glows, Position, Velocity, Glow, Rotatable, Character
from . import gfx
from . import rng
...
def seed_fonts():
    ...
    esper.add_component(fonts_entity, Fonts(
        extra_small=pygame.font.Font(gfx.get_font_file(), FontSizes.EXTRA_SMALL.value),
        ...
        extra_large=pygame.font.Font(gfx.get_font_file(), FontSizes.EXTRA_LARGE.value),
    ))
